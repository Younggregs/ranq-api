    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('signup_email', 'signup_email'), ('vote_email', 'vote_email'), ('forgot_password', 'forgot_password')], default='signup_email', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_s', models.BigIntegerField(blank=True, default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contestant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ranq_app.contestant')),
                ('poll_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ranq_app.poll')),
                ('voter_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ranq_app.voter')),
            ],
            bases=('ranq_app.basemodel',),
        ),
        migrations.CreateModel(
